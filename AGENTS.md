...
Write tests as plain functions with pytest fixtures. Don't use class-based tests, except for
multi-GPU distributed tests, which subclass `DTest` (`tests/dtest.py`) — the class gives
